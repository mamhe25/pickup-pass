...
@HiltViewModel
class CampusGateViewModel @Inject constructor(private val repository: SchoolAdminRepository): ViewModel() {
    ...
    fun load() = viewModelScope.launch {
        ...
        when(val r=repository.getCampusGates()) {
            is ApiResult.Success -> _uiState.value = _uiState.value.copy(loading=false,campuses=r.data.campuses,gates=r.data.gates)
