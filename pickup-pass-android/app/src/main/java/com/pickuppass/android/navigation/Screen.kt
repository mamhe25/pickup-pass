...
sealed class Screen(val route: String) {
    ...
    data object MasterAdminHome : Screen("master-admin/home")
    ...
    data object SchoolAdminDismissalReports : Screen("school-admin/dismissal-reports")

    data object SchoolAdminGuardianVerification : Screen("school-admin/guardian-verification")

    data object SchoolAdminCampusGates : Screen("school-admin/campus-gates")
    data object SchoolAdminStaffPickupGates : Screen("school-admin/staff-pickup-gates")
    data object SchoolAdminBilling : Screen("school-admin/billing")
    data object SchoolAdminDataExport : Screen("school-admin/data-export")
    data object SchoolAdminLaunchReadiness : Screen("school-admin/launch-readiness")
}
