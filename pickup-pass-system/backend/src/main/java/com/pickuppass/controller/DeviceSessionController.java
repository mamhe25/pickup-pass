...
public class DeviceSessionController {
    ...
    public ResponseEntity<?> list(
            ...
            @RequestHeader(
                    value = DeviceSessionFilter.DEVICE_ID,
                    required = false)
            String currentDeviceId) throws Exception {
    ...
    public ResponseEntity<?> revoke(
        ...
        pushNotifications.sendSessionRevocation(
                user.getUid(),
                deviceId,
                null);
    ...
    public ResponseEntity<?> revokeOthers(
            @AuthenticationPrincipal FirebaseUserDetails user,
            @RequestHeader(
                    value = DeviceSessionFilter.DEVICE_ID,
                    required = false)
